...
<?php
				if(isset($_POST['login'])){
					...
					$pass = $_POST['pass'];
           $phone =$_POST['phone'];
					$query = "SELECT * FROM usertb WHERE email = '$uname' AND contact = '$phone'";
					$rs = $conn->query($query);
					$num = $rs->num_rows;
					$rows = $rs->fetch_assoc();
					if($num > 0){
                        $sql = "UPDATE usertb SET pass='$pass' WHERE email = '$uname' AND contact = '$phone'";
              ...
              <div class="text-center col-lg-12">
                ...
                <form action="" method="post">
                  ...
                  <label class="form-label" for="form2Example11">Phone</label>
                    <input type="text" name="phone" id="form2Example11" class="form-control" />
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    ...
                    <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" name="login">submit</button>
