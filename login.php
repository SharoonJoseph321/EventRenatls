...
<?php
				if(isset($_POST['login'])){
					...
					$query = "SELECT * FROM usertb WHERE email = '$uname' AND pass = '$pass'";
					$rs = $conn->query($query);
					$num = $rs->num_rows;
					$rows = $rs->fetch_assoc();
					if($num > 0){
            ...
            $_SESSION['lname'] = $rows['lname'];
						$_SESSION['u_id'] = $rows['cust_id'];
            $_SESSION['email'] = $rows['email'];
            $_SESSION['phone'] = $rows['contact'];
              ...
              <div class="text-center col-lg-12">
                ...
                <form action="" method="post">
                  ...
                  <label class="form-label" for="form2Example22">Password</label>
                    ...
                    <i id="pass-status" class="fa fa-eye" aria-hidden="true" onClick="viewPassword()"style="position:absolute;top:58%; left:75%"></i>
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    ...
                    <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" name="login">Log
                      in</button>
                      <a class="text-muted" href="forgotpass.php">Forgot password?</a>
                  </div>
